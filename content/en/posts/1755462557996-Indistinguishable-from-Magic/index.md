...
Yet hunting around online reveals even the insiders at frontier labs are [still working](https://www.anthropic.com/research) to understand the inner workings of LLMs. Models continue to march ahead in capabilities, but the underlying mechanisms remain elusive.
...
After speaking with people who work directly on LLMs and also doing a bit of background reading, I've discovered something unsettling: even insiders possess only piecewise knowledge of how intelligence emerges from data. It's like trying to understand how a rabbits jump by examining the molecular interactions within individual cells. Experiments at the micro-scale are beginning to bear fruit, but macro-scale understanding remains elusive.
